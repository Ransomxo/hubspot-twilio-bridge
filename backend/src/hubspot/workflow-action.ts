...
export const smsCrmCard: CrmCardDefinition = {
  ...
  fetch: {
    ...
    targetUrl: process.env.APP_URL ? `${process.env.APP_URL}/api/crm-card` : "http://localhost:3001/api/crm-card",
    ...
    actions: [
      {
        ...
        width: 890,
        height: 748,
        uri: process.env.APP_URL ? `${process.env.APP_URL}/sms-composer` : "http://localhost:3001/sms-composer",
        label: "Send SMS"
      }
    ]
  }
